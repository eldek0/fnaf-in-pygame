import include.pygame_shaders.texture as texture
import include.pygame_shaders.screen_rect as screen_rect
import include.pygame_shaders.shader_utils as shader_utils
